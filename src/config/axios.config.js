...
let $instance = axios.create({
  ...
  baseURL:  _APP_HISTORY_ == 2 ? (process.env.NODE_ENV == 'development' ? 'https://hash-api.888bbm.com/api' : "https://hash-api.hashgo888.com/api") : (process.env.NODE_ENV == 'development' ? 'https://hash-api.888bbm.com/api' : "/api"),
