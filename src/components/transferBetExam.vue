...
<template>
  <div>
    ...
    <template v-if="userInfo.gameType == 1">
      <div class="set-bg-color pt-10 pb-18 pl-10 pr-24 rounded-md mb-65">
        <div class="label-text-color text-xs mb-21 font-medium">范例一</div>
        ...
        <div class="label-text-color text-xs my-21 font-medium">范例二</div>
        <div class="text-ll value-text-color font-medium">
